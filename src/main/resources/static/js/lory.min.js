  ...
  return (function (e) {
    ...
    function (e, t, n) {
      ...
      function o(e, t) {
        ...
        function s(e, t, n) {
          var i = k && k.style;
          i && ((i[A.transition + "TimingFunction"] = n), (i[A.transition + "Duration"] = t + "ms"), (i[A.transform] = "translateX(" + e + "px)"));
        }
        function l(e) {
        ...
        function c(e, t) {
          var i = F,
            ...
            p = i.classNameDisabledNextCtrl,
            b = void 0 === p ? "disabled" : p,
            h = i.classNameDisabledPrevCtrl,
            E = void 0 === h ? "disabled" : h,
            y = r,
            L = t ? z + 1 : z - 1,
            x = Math.round(_ - S);
          o("before", "slide", { index: z, nextSlide: L }),
            B && B.classList.remove(E),
            T && T.classList.remove(b),
            "number" != typeof e && (e = t ? (l && z + 2 * l !== P.length ? z + (l - (z % l)) : z + a) : l && z % l != 0 ? z - (z % l) : z - a),
            (e = Math.min(Math.max(e, 0), P.length - 1)),
            l && void 0 === t && (e += l),
            c && 0 === Math.abs(j.x) && !1 === t && ((e = P.length - 1), (y = u));
          var w = Math.min(Math.max(-1 * P[e].offsetLeft, -1 * x), 0);
          d && Math.abs(j.x) === x && t && ((w = 0), (e = 0), (y = u)),
            s(w, y, v),
            (j.x = w),
            P[e].offsetLeft <= x && (z = e),
            !l ||
              (e !== P.length - l && e !== P.length - (P.length % l) && 0 !== e) ||
              (t && (z = l),
              t || (z = P.length - 2 * l),
              (j.x = -1 * P[z].offsetLeft),
              (D = function () {
                s(-1 * P[z].offsetLeft, 0, void 0);
              })),
            f && n(m.call(P), z),
            !B || l || c || 0 !== e || B.classList.add(E),
            !T || l || d || e + 1 !== P.length || T.classList.add(b),
        ...
        function v() {
          ...
          var s = F,
            l = s.classNameFrame,
            d = s.classNameSlideContainer,
            c = s.classNamePrevCtrl,
            u = s.classNameNextCtrl,
            v = s.classNameDisabledNextCtrl,
            b = void 0 === v ? "disabled" : v,
            h = s.classNameDisabledPrevCtrl,
            L = void 0 === h ? "disabled" : h,
            x = s.enableMouseEvents,
            g = s.classNameActiveSlide,
            N = s.initialIndex;
          (z = N),
            (O = e.getElementsByClassName(l)[0]),
            (k = O.getElementsByClassName(d)[0]),
            (B = e.getElementsByClassName(c)[0]),
            (T = e.getElementsByClassName(u)[0]),
            (j = { x: k.offsetLeft, y: k.offsetTop }),
            F.infinite ? (P = i(m.call(k.children))) : ((P = m.call(k.children)), B && !F.rewindPrev && B.classList.add(L), T && 1 === P.length && !F.rewind && T.classList.add(b)),
            p(),
            g && n(P, z),
            B && T && (B.addEventListener("click", E), T.addEventListener("click", y)),
            O.addEventListener("touchstart", w, I),
            x && (O.addEventListener("mousedown", w), O.addEventListener("click", C)),
        ...
        function p() {
          ...
          (_ = l(k)),
            ...
            r ? (z = d) : ((i = null), (o = 0)),
            t ? (s(-1 * P[z + t].offsetLeft, 0, null), (z += t), (j.x = -1 * P[z].offsetLeft)) : (s(-1 * P[z].offsetLeft, o, i), (j.x = -1 * P[z].offsetLeft)),
            a && n(m.call(P), z);
        }
        function b(e) {
          c(e);
        ...
        function L() {
          o("before", "destroy"),
            ...
            F.window.removeEventListener("resize", M),
            B && B.removeEventListener("click", E),
        ...
        function w(e) {
          ...
          n && (O.addEventListener("mousemove", g), O.addEventListener("mouseup", N), O.addEventListener("mouseleave", N)), O.addEventListener("touchmove", g, I), O.addEventListener("touchend", N);
          var r = i.pageX,
            s = i.pageY;
          (X = { x: r, y: s, time: Date.now() }), (Q = void 0), (R = {}), o("on", "touchstart", { event: e });
        }
        function g(e) {
          var t = e.touches ? e.touches[0] : e,
            n = t.pageX,
            i = t.pageY;
          (R = { x: n - X.x, y: i - X.y }), void 0 === Q && (Q = !!(Q || Math.abs(R.x) < Math.abs(R.y))), !Q && X && s(j.x + R.x, 0, null), o("on", "touchmove", { event: e });
        }
        function N(e) {
          var t = X ? Date.now() - X.time : void 0,
            n = (Number(t) < 300 && Math.abs(R.x) > 25) || Math.abs(R.x) > S / 3,
            i = (!z && R.x > 0) || (z === P.length - 1 && R.x < 0),
            r = R.x < 0;
          Q || (n && !i ? c(!1, r) : s(j.x, F.snapBackSpeed)),
            (X = void 0),
        ...
        var j = void 0,
          ...
          z = 0,
          F = {},
          I = !!(0, d.default)() && { passive: !0 };
        "undefined" != typeof jQuery && e instanceof jQuery && (e = e[0]);
        var X = void 0,
          R = void 0,
          Q = void 0;
        return v(), { setup: v, reset: p, slideTo: b, returnIndex: h, prev: E, next: y, destroy: L };
      }
        ...
        return (
          (function () {
            var i = document.createElement("_"),
              o = i.style,
              r = void 0;
            "" === o[(r = "webkitTransition")] && ((n = "webkitTransitionEnd"), (t = r)),
      ...
      (function (t) {
        ...
        e.exports = (function () {
          ...
          : function (e, t) {
              ...
              return (
                (n.type = e), t ? ((n.bubbles = Boolean(t.bubbles)), (n.cancelable = Boolean(t.cancelable)), (n.detail = t.detail)) : ((n.bubbles = !1), (n.cancelable = !1), (n.detail = void 0)), n
              );
            };
      }.call(t, n(5)));
    },
